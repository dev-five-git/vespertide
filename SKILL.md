...
See [EXAMPLES.md](EXAMPLES.md) for full model definitions (user table with enums, order table with CHECK constraints, many-to-many join table).
...
See [REFERENCE.md](REFERENCE.md) for naming conventions, quick type/constraint reference card, and troubleshooting guide.
